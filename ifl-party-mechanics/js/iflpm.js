...
$(document).ready( function(){
    ...
    /* REGISTRATION FORM */
    $('.nfc-wrapper button').click(function(){

        // get reader id
        reader_id = 1;
        reader_value = 0;
        url = "http://mint.ideafablabs.com/index.php/wp-json/mint/v1/readers/"+reader_id;
        // get reader value.
    ...
    $('a.admit-button').on('click', function(e) { 
        ...
        $.ajax({
            ...
            // security : iflag_ajax.check_nonce,
